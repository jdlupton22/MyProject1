...
function populateData(responseBody) {
    for (let reimbursement of responseBody) {
        ...
        <td>${reimbursement.empId}</td>
        <td>${reimbursement.evLocation}</td>
        <td>${reimbursement.evCost}</td>
        <td>${reimbursement.evType}</td>
        <td>${reimbursement.description}</td>
        <td>${reimbursement.justification}</td>
        <td>${reimbursement.gradingFormat}</td>
        <td>${reimbursement.grade}</td>`
